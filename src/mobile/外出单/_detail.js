    ...
    init : function(obj){
        ...
        cloundOfficeApp = new Vue({
            ...
            data:{
                ...
                dStartDate : moment(receiptData.dStartDate).format("YYYY-MM-DD HH:mm") || '',// 外出开始时间
                dEndDate : moment(receiptData.dEndDate).format("YYYY-MM-DD HH:mm") || '',// 外出结束时间
                lAllTime : receiptData.lAllTime || 0,                               // 外出总时长
            ...
            computed : {
                ...
                staticList : function(){
                    ...
                    var total = 0;
                    arr.title = "外出统计";
                    arr.content = [{"nameY": "次数", "data": []},{"nameY": "总共时数", "data": []}];
                    arr.nameX = [];
                    arr.column = [];
                    for(var i = 0; i < len; i ++){
